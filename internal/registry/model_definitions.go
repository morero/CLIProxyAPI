...
func GetClaudeModels() []*ModelInfo {
	return []*ModelInfo{
		...
		// Claude 4.6 - Latest flagship model
		{
			ID:                  "claude-opus-4-6",
			Object:              "model",
			Created:             1770000000, // 2026-02-02 (approximate)
			OwnedBy:             "anthropic",
			Type:                "claude",
		...
		// Claude 4.6 Opus with 1M context (beta)
		{
			...
			OwnedBy:             "anthropic",
			Type:                "claude",
			DisplayName:         "Claude 4.6 Opus (1M context)",
			Description:         "Most intelligent model with extended 1M token context window",
			ContextLength:       1000000,
			MaxCompletionTokens: 128000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: true},
		},

		// TOON-enabled aliases (simplified model names with TOON compression)
		{
			ID:                  "claude-opus-toon",
			Object:              "model",
			Created:             1770000000,
			OwnedBy:             "anthropic",
			Type:                "claude",
			DisplayName:         "Claude Opus (TOON)",
			Description:         "Latest Claude Opus with TOON compression for reduced token usage",
			ContextLength:       200000,
			MaxCompletionTokens: 128000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: true},
		},
		{
			ID:                  "claude-sonnet-toon",
			Object:              "model",
			Created:             1759104000,
			OwnedBy:             "anthropic",
			Type:                "claude",
			DisplayName:         "Claude Sonnet (TOON)",
			Description:         "Latest Claude Sonnet with TOON compression for reduced token usage",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: false},
		},
		{
			ID:                  "claude-haiku-toon",
			Object:              "model",
			Created:             1759276800,
			OwnedBy:             "anthropic",
			Type:                "claude",
			DisplayName:         "Claude Haiku (TOON)",
			Description:         "Latest Claude Haiku with TOON compression for reduced token usage",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
		...
		// Claude 4.5 Sonnet with 1M context (beta)
		{
			...
			Description:         "Fast, intelligent model with extended 1M token context window",
			ContextLength:       1000000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: false},
		},
		...
		// Claude 4 Sonnet with 1M context (beta)
		{
			...
			OwnedBy:             "anthropic",
			Type:                "claude",
			DisplayName:         "Claude 4 Sonnet (1M context)",
			Description:         "Fast, intelligent model with extended 1M token context window",
			ContextLength:       1000000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: false, DynamicAllowed: false},
...
func GetGeminiModels() []*ModelInfo {
	return []*ModelInfo{
		...
		// TOON-enabled aliases (simplified model names with TOON compression)
		{
			...
			Name:                       "models/gemini-2.5-pro",
			Version:                    "2.5",
			DisplayName:                "Gemini Pro (TOON)",
			Description:                "Latest Gemini Pro with TOON compression for reduced token usage",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens", "createCachedContent", "batchGenerateContent"},
			Thinking:                   &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true},
		},
		{
			...
			Name:                       "models/gemini-2.5-flash",
			Version:                    "2.5",
			DisplayName:                "Gemini Flash (TOON)",
			Description:                "Latest Gemini Flash with TOON compression for reduced token usage",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens", "createCachedContent", "batchGenerateContent"},
			Thinking:                   &ThinkingSupport{Min: 0, Max: 24576, ZeroAllowed: true, DynamicAllowed: true},
...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		// TOON-enabled aliases (simplified model names with TOON compression)
		{
			...
			Type:                "openai",
			Version:             "gpt-5.2",
			DisplayName:         "GPT (TOON)",
			Description:         "Latest GPT with TOON compression for reduced token usage",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"none", "low", "medium", "high", "xhigh"}},
		},
		{
			...
			Type:                "openai",
			Version:             "gpt-5.2",
			DisplayName:         "GPT Codex (TOON)",
			Description:         "Latest GPT Codex with TOON compression for reduced token usage",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
